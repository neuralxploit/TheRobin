# TheRobin — OpenCode Integration Guide
...
Once OpenCode starts, tell it to read the integration guide:

```
Read OPENCODE.md
```

This will load all the phase guides and rules. Then start your pentest:
